...
function chatHeartbeat()
{
	...
	while ($chat = mysql_fetch_array($query))
    {
		...
		$ffn = utf8_decode($chat['from_fullname']);
		$tfn = utf8_decode($chat['to_fullname']);
...
function sendChat()
{
	...
	$toname = $_POST['tofullname'];
        $fromname = $_POST['fromfullname'];
...
EOD;
	...
	$sql = "insert into chat (
                        ...
                        NOW(),
                        '".mysql_real_escape_string(utf8_decode($fromname))."',
                        '".mysql_real_escape_string(utf8_decode($toname))."'
                )";
