			...
			<div id="link-form" style="display:none">
				<form action="<?php echo base_url('social/post_create'); ?>" method="POST">
					...
					<div class="link-preview">
						<div class="col-sm-3">
							<img src="" class="lint-img img-responsive" />
						</div>
						<div class="col-sm-9">
			...
			<div class="feed-box">
				<div class="top-info inner-all">
					...
					<div class="post-editing">
						...
						<button class="btn blue post-edit-save">Save</button>
						<button class="btn white post-edit-cancel">Cancel</button>
					</div>
					...
					<div class="post-attach post-link">
						...
						<div class="col-sm-9">
							<div class="inner-all">
								<div class="lint-title col-sm-12"><a target="_blank"></a></div>
								<div class="lint-desc col-sm-12"></div>
								<div class="lint-url col-sm-12"></div>
							</div>
						</div>
					</div>
					<div class="clearfix"></div>
...
<script type="text/javascript">
	var timelineOwner = <?php echo $target ? $target['id'] : 0; ?>
</script>
