...
<div class="sidebar_widget">
	...
	<ul class="sidebar_left">
		...
		<li class="<?php echo ($cut_ruri[1]=="profile")?"active":"" ?>"><a href="<?php echo base_url('dashboard/profile'); ?>">
