...
<div class="diagnosis-box">
	<div class="patient-box inner-all">
		<div class="patient-info">
			<img class="pull-left" src="<?php echo CA_Media::userpic($appointment->patPP,'150'); ?>">
			<a href="<?php echo base_url('user/'.$appointment->patUN); ?>" class="patient-name">
				<?php echo $appointment->patFN; ?> <?php echo $appointment->patLN; ?>
			</a>
			<span class="clinic">
				&nbsp;
			</span>
	...
	<div class="diagnosis-form inner-all">
		...
		<!-- Tab's Nav -->
		<ul class="tab_nav">
			<li class="active" data-tab="schedule">Schedule</li>
			<li data-tab="diagnosis">Diagnosis</li>
			<li data-tab="collab">Collaboration</li>
		...
		<?php echo form_open('dashboard/physician/appointments/saveSchedule'); ?>
			...
			<span class="patient_notes"><?php echo $appointment->patient_note; ?></span>
			<br /><br /><br /><br />
		...
		<!-- DIAGNOSIS -->
		<div class="tab diagnosis" style="display:none">
