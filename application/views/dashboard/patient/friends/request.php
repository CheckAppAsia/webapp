<div class="simple_tabs">
	<span class="active tab-open" data-tab-id="friend_requests">Friend Request (<?php echo $friend_count['requests']; ?>)</span>
...
<div class="tab_content">
	...
	<div class="tab requests active" id="friend_requests">
		<div class="pending_list">
			<h2 class="form_heading">Pending Friend Request</h2>
			<?php foreach($requests as $request){ ?>
				<div class="request" target_id="<?php echo $request->account_id; ?>">
					<form method="post" action="<?php echo base_url('dashboard/patient/friends/rejectFriend'); ?>">
					...
					<form method="post" action="<?php echo base_url('dashboard/patient/friends/acceptFriend'); ?>">
						<input type="hidden" name="target_id" value="<?php echo $request->account_id; ?>"/>
		...
		<div class="pending_list">
			...
			<?php foreach($invites as $invite){ ?>
				<div class="request" target_id="<?php echo $invite->account_id; ?>">
					...
					<form method="post" action="<?php echo base_url('dashboard/patient/friends/cancelFriend'); ?>">
