...
class CA_Email extends CI_Email {
    ...
    public function __construct($config = array()) {
        ...
        if ($this->mailer_engine == 'phpmailer') {
            ...
            if (!class_exists('PHPMailer', false)) {
                require_once APPPATH.'third_party/phpmailer/sdk/PHPMailerAutoload.php';
            }
            //

            $this->phpmailer = new PHPMailer();
            $this->phpmailer->PluginDir = APPPATH.'third_party/phpmailer/sdk/';
